...
class YouTubeService:
    ...
    def get_video_info(self, url: str) -> Optional[VideoInfo]:
        ...
        try:
            ...
            video_info = VideoInfo(
                title=yt.title, thumbnail_url=yt.thumbnail_url, length=yt.length
            )
    ...
    def get_video_resolutions(self, video_url: str) -> List[str]:
        ...
        try:
            ...
            resolutions = [
                stream.resolution for stream in stream_list if stream.resolution
            ]
    ...
    def download_video_to_buffer(
        self, url: str, selected_resolution: str
    ) -> Optional[BinaryIO]:
        """
        ...
        try:
            logger.info(
                f"Starting video download for {url} at resolution {selected_resolution}"
            )
